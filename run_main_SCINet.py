...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'calce_dataset', 'dataset4'], help='name of dataset') # ETTh2 instead of dataset4
parser.add_argument('--root_path', type=str, default='./datasets/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='trial.csv', help='location of the data file')
parser.add_argument('--features', type=str, default='M', choices=['S', 'M'], help='features S is univariate, M is multivariate')
parser.add_argument('--target', type=str, default='Current', help='target feature')
...
parser.add_argument('--loss', type=str, default='mae',help='loss function') #original=mae
parser.add_argument('--lradj', type=int, default=1,help='adjust learning rate')
parser.add_argument('--use_amp', action='store_true', help='use automatic mixed precision training', default=False)
parser.add_argument('--save', type=bool, default =False, help='save the output results') #results is being formed for True
parser.add_argument('--model_name', type=str, default='SCINet')
parser.add_argument('--resume', type=bool, default=False) #false
parser.add_argument('--evaluate', type=bool, default=False) #True
...
data_parser = {
    ...
    'datset4': {'data':'trial.csv', 'T':'Current', 'M':[4,4,4], 'S':[1,1,1], 'MS':[4,4,1]},
